        ...
        <div className="grid gap-10 lg:grid-cols-[2fr_1fr]">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6 text-sm text-blue-300/70">
              ...
              <li className="flex items-center gap-2.5">
                <Phone className="h-4 w-4 text-blue-500 flex-shrink-0" />
                <a href="tel:+234800762427" className="hover:text-blue-300 transition">
                  +234 800 ROCHAS
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="h-4 w-4 text-blue-500 flex-shrink-0" />
                <a href="mailto:admissions@rochas.edu.ng" className="hover:text-blue-300 transition">
                  admissions@rochas.edu.ng
                </a>
              </li>
              <li className="flex items-center gap-2.5">
            ...
            <div className="rounded-xl bg-red-500/10 border border-red-500/20 px-4 py-3 mb-6">
              ...
              <a 
                ...
                className="text-sm font-bold text-white hover:text-red-300 transition"
              >
                +234 800 911 0000
              </a>
            </div>
            ...
            <div className="flex gap-2">
              {socials.map(({ icon: Icon, href, label, hover }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className={`h-9 w-9 rounded-lg bg-white/5 border border-blue-800/40 flex items-center justify-center text-blue-400 hover:text-white transition-all ${hover}`}
          ...
          {/* Accreditation badges, moved into the grid for balance */}
          <div>
            <h4 className="text-xs uppercase tracking-widest text-blue-400 font-semibold mb-4">
              Accreditations
            </h4>
            <div className="flex flex-col gap-3">
              {accreditations.map((badge) => (
                <div
                  key={badge}
                  className="flex items-center gap-2 rounded-lg border border-blue-700/30 bg-white/5 px-3 py-1.5 w-fit"
                >
                  <div className="h-1.5 w-1.5 rounded-full bg-blue-400" />
                  <span className="text-xs text-blue-300/60 font-medium">{badge}</span>
                </div>
