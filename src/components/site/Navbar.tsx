          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center gap-0.5">
              {mainLinks.map((link) => (
                <Link
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-semibold text-white/90 hover:text-white hover:bg-white/10 transition-all"
                  activeProps={{
                    className:
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label="Search"
                className="hidden md:flex h-9 w-9 items-center justify-center rounded-lg text-white/80 hover:text-white hover:bg-white/10 transition"
              >
        ...
        {searchOpen && (
          <div className="border-t border-blue-800/40 bg-blue-950 px-6 py-3">
            <div className="mx-auto max-w-2xl flex items-center gap-3 bg-white/5 border border-blue-700/40 rounded-xl px-4 py-2.5">
              <Search className="h-4 w-4 text-blue-300 flex-shrink-0" />
              <input
                autoFocus
                value={query}
                onChange={e => setQuery(e.target.value)}
                placeholder="Search courses, news, events, staff…"
                className="flex-1 bg-transparent outline-none text-sm text-white placeholder:text-blue-300/60"
              />
              <kbd className="text-[10px] text-blue-200/80 bg-blue-900/60 px-1.5 py-0.5 rounded border border-blue-700/40">
                esc
              </kbd>
            </div>
          </div>
