...
//             <motion.img src={IMGS.campus} alt="Rochas Foundation campus"
//               style={{ y: imgY }}
...
//                   </div>
//                 </div>
//                 <div className="bg-blue-900/50 p-5">
...
//               className="rounded-2xl bg-blue-900/40 border border-blue-800/40 p-5 text-center hover:border-blue-700/60 transition-colors">
...
//               className="rounded-2xl bg-blue-900/30 border border-blue-800/40 p-6 hover:border-blue-700/60 hover:-translate-y-0.5 transition-all duration-300">
